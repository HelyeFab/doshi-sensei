...
const securityHeaders = [
  ...
  process.env.NODE_ENV === 'development'
    ...
    : {
        key: 'Content-Security-Policy',
        value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://*.stripe.com https://apis.google.com https://www.gstatic.com https://www.googletagmanager.com https://www.youtube.com https://s.ytimg.com; script-src-elem 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://*.stripe.com https://apis.google.com https://www.gstatic.com https://www.googletagmanager.com https://www.youtube.com https://s.ytimg.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.stripe.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: blob: https: http: https://raw.githubusercontent.com https://watanoc.com https://lh3.googleusercontent.com https://*.googleusercontent.com https://*.stripe.com https://i.vimeo.com https://www.google.com; media-src 'self' blob: https: https://watanoc.com; connect-src 'self' https://*.stripe.com wss://*.stripe.com https://apis.google.com https://*.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://api.googleapis.com https://firestore.googleapis.com https://firebaseio.com https://*.firebaseio.com wss://*.firebaseio.com https://www.youtube.com https://youtube.com https://raw.githubusercontent.com https://watanoc.com https://lh3.googleusercontent.com https://*.googleusercontent.com https://api.wanikani.com https://i.vimeo.com https://www.google.com; frame-src 'self' https://js.stripe.com https://*.stripe.com https://hooks.stripe.com https://checkout.stripe.com https://*.firebaseapp.com https://doshi-sensei.firebaseapp.com https://www.youtube.com https://youtube.com; frame-ancestors 'none';"
      }
];
    ...
    return [
      ...
      },
      {
        ...
        headers: [
          ...
          { key: 'Access-Control-Allow-Origin', value: process.env.NODE_ENV === 'development' ? '*' : (process.env.ALLOWED_ORIGIN || 'https://doshisensei.com') },
