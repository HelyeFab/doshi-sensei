        ...
        <div className="px-4 pb-4 bg-card border-b border-border">
          ...
          <div className="flex gap-2 max-w-md">
            ...
            <button
              ...
              className="px-3 py-2 md:px-4 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors flex items-center justify-center"
              aria-label="Search by SKIP code"
            >
