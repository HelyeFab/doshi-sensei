    ...
    <div className="space-y-6">
        ...
        {lessonsWithProgress.map((lesson) => {
          ...
          return (
            <div
              ...
              className={`bg-white rounded-lg shadow-sm border p-4 transition-all cursor-pointer ${
                isSelected
      ...
      {selectedLesson && (
        <button
          ...
          className="w-full py-3 px-4 rounded-lg bg-blue-500 text-white hover:bg-blue-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
      ...
      {showResetConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full">
            <h3 className="text-lg font-semibold mb-3">Reset Progress?</h3>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-2 px-4 rounded-lg bg-gray-200 text-gray-700 hover:bg-gray-300"
              >
                Cancel
              </button>
              <button
