          ...
          <div className="max-w-md w-full bg-card rounded-lg shadow-lg p-6 border border-border">
            ...
            {process.env.NODE_ENV === 'development' && (
              <details className="mb-4">
                ...
                <pre className="mt-2 text-xs bg-muted/10 p-2 rounded overflow-auto">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="flex items-center justify-center px-4 py-2 bg-primary text-primary-foreground rounded hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
              >
