...
export function OnboardingFlow({ onComplete }: OnboardingFlowProps) {
  ...
  return (
    ...
    >
      ...
      {/* Main Content Container - flex-1 to take remaining space */}
      <div className="flex-1 relative overflow-y-auto overflow-x-hidden flex justify-center pt-12 md:pt-20">
      ...
      {/* Navigation Container - auto height, stays at bottom */}
      <NavigationBar
        ...
        showNext={state.currentScreen < screens.length - 1}
