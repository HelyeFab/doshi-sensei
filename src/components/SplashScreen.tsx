...
export default function SplashScreen({ onComplete }: SplashScreenProps) {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-purple-500 to-purple-600 transition-opacity duration-500 ${
    ...
    >
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-orange-400 app-name mb-2">
          Doshi Sensei
        </h1>
        <p className="text-lg text-orange-300 japanese-text mb-2">
          動詞 先生
        </p>
        <p className="text-sm text-orange-200 max-w-xs mx-auto">
      ...
      <div className="absolute bottom-1/4 left-1/3 w-1.5 h-1.5 bg-white/20 rounded-full animate-pulse delay-700"></div>
    </div>
  );
}
