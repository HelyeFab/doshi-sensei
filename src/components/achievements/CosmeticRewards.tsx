...
export function CosmeticRewards({ className = '' }: CosmeticRewardsProps) {
  ...
  const getRarityStyles = (rarity: string) => {
    switch (rarity) {
      case 'common':
        return { border: 'border-border', bg: 'bg-muted', text: 'text-foreground', glow: '' };
      case 'rare':
        return { border: 'border-primary', bg: 'bg-primary/10', text: 'text-primary', glow: 'shadow-primary/20' };
      case 'epic':
        return { border: 'border-purple-500', bg: 'bg-purple-500/10', text: 'text-purple-700', glow: 'shadow-purple-500/20' };
      case 'legendary':
        return { border: 'border-yellow-500', bg: 'bg-yellow-500/10', text: 'text-yellow-700', glow: 'shadow-yellow-500/20' };
      default:
        return { border: 'border-border', bg: 'bg-muted', text: 'text-foreground', glow: '' };
    }
  };
