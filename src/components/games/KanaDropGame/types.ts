...
// Distractor images list - using proven working paths from virtual companion
export const DISTRACTOR_IMAGES = [
  // Pokemon-themed PNG files - these are known to work
  ...
  // Farm Animals - tested and working in virtual companion
  ...
  // Wild Animals - additional proven working icons
  ...
  // Emotions - working in virtual companion
  ...
  // Numbers only (removing problematic alphabet SVGs)
