  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <motion.div
          className="relative bg-card/80 backdrop-blur-sm border-2 border-border rounded-2xl px-6 py-8 md:px-12 md:py-10 shadow-xl"
        ...
        >
                ...
                {index < parts.length - 1 && (
                  ...
                  >
                    <span className="relative">
                      ...
                      <span 
                        className="absolute inset-0 blur-md text-primary opacity-50"
                        aria-hidden="true"
                      >
                        {kanjiChar}
                      </span>
          ...
          >
            Choose the correct reading for <span className="text-primary font-semibold">{kanjiChar}</span> in this context
          </motion.div>
        </motion.div>
        ...
        />
        <motion.div
          className="absolute -bottom-4 -right-4 w-6 h-6 border-2 border-secondary/30 rounded-full"
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.3, 0.6, 0.3],
          }}
