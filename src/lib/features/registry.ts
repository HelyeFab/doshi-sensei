...
const _internalRegistry: Record<string, Feature> = {
  ...
  'kanji_radicals': {
    id: 'kanji_radicals',
    name: 'Semantic Radicals',
    description: 'Explore kanji through semantic radicals and meaning clusters',
    category: 'learning',
    icon: '⚛️',
    limitType: 'daily',
    requiresAuth: false,
  ...
  'kanji_visual_layout': {
    id: 'kanji_visual_layout',
    name: 'Visual Layout (SKIP)',
    description: 'Navigate kanji by visual structure and shape patterns',
    category: 'learning',
    icon: '🎨',
    limitType: 'daily',
    requiresAuth: false,
  ...
  'kanji_connections': {
    id: 'kanji_connections',
    name: 'Kanji Connections',
    description: 'Explore kanji through families, radicals, and visual patterns',
    category: 'learning',
    icon: '🔮',
    limitType: 'daily',
    requiresAuth: false,
  ...
  'view_stroke_order': {
    id: 'view_stroke_order',
    name: 'View Stroke Order',
    description: 'View animated stroke order for kanji characters',
    category: 'learning',
    icon: '📝',
    limitType: 'daily',
    requiresAuth: false,
  ...
  'ai_transcript_formatting': {
    id: 'ai_transcript_formatting',
    name: 'AI Transcript Formatting',
    description: 'Format video transcripts with AI for better readability',
    category: 'tools',
    icon: '🤖',
    limitType: 'daily',
    requiresAuth: false,
  ...
  'ai_article_validation': {
    id: 'ai_article_validation',
    name: 'AI Article Validation',
    description: 'Validate and enhance articles with AI quality analysis',
    category: 'system',
    icon: '✅',
    limitType: 'daily',
    requiresAuth: true,
  ...
  'ai_cover_generation': {
    id: 'ai_cover_generation',
    name: 'AI Cover Generation',
    description: 'Generate cover images for content using AI',
    category: 'tools',
    icon: '🎨',
    limitType: 'daily',
    requiresAuth: true,
  ...
  'quick_context': {
    id: 'quick_context',
    name: 'Quick Context Bubble',
    description: 'Get instant help with selected Japanese text - AI explanations, dictionary, TTS, and save',
    category: 'learning',
    icon: '💬',
    limitType: 'daily',
    requiresAuth: false,
  ...
  'article_reading': {
    ...
    description: 'Read individual news articles',
    category: 'tools',
    icon: '📄',
    limitType: 'daily',
    requiresAuth: false,
  ...
  'article_bookmarks': {
    id: 'article_bookmarks',
    name: 'Article Bookmarks',
    description: 'Bookmark news articles for later reading',
    category: 'storage',
    icon: '🔖',
    limitType: 'total',
    requiresAuth: true,
