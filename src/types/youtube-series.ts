...
/**
 * YouTube Series Monitoring Types
 * For tracking and automatically importing valuable YouTube series as resources
 */
...
export interface YouTubeChannel {
  ...
  isPremiumContent: boolean; // Mark resources as premium
  
  // Shadowing integration
  autoExtractTranscript: boolean; // Auto-extract with SupaData
